...
results_lr, results_lm = analyze_remarkable_correlations(average_df, {"CLIP_annotation":["fishing","cooking","sport","scene","outdoors"],"model_embedding":["resnet3d50","multi_resnet3d50","CLIP"]}, combined_rsm, roi_neural_rsm, r_threshold=0.1)
